...
const Navigation = () => {
    ...
    return (
        <div >
            <div className="fixed bottom-10 left-[30rem] transform translate-x-1/2 translate-y-1/2 z-50 bg-[#2b2b2b] border w-[30%] px-[4rem] mb-[2rem] rounded">
                        ...
                        {dropdownOpen && userInfo && (
                            ...
                            >
                                {userInfo.isAdmin && (
                                    <>
                                        <li>
                                            <Link to="/admin/movie/dashboard" className="block px-4 py-2 hover:bg-gray-100">
                                                Dashboard
                                            </Link>
                                        </li>
                                    </>
                                ...
                                <li>
                                    ...
                                    <button onClick={logoutHandler} className="block w-full px-4 py-p2 text-left hover:bg-gray-100">
                                        Logout
                                    </button>
                                </li>
                            </ul>
